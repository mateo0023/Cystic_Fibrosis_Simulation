...
A_CONS_OI = 8.0  # Other ions concentration in the apical compartment. ------ mM (milli-moles / litter)
C_CONS_OI = 29.0  # Concentration of other ions in the cellular compartment. ------ mM (milli-moles / litter)
...
COT_D = 0.199e-10  # Density of the NKCC Cotransporter \pm 0.408e-10 (IQR) - mol / cm^2
COT_K_Cl = 2.42  # mM
COT_K_Na = 22.38  # mM
COT_K_K = 234.74  # mM
